 ...
 * @author Akash
 */
public class AddBuyDetails extends javax.swing.JFrame {

    /**
             * Creates new form AddSalesDetails
             */

    public AddBuyDetails() {
        initComponents();
    }
    ...
    private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
        ...
        m.put("Date", dateSel);
        m.put("Name", nameSel);
        m.put("ProductId", productIDSel);
        m.put("Quantity", quantitySel);
        m.put("Rate", rateSel);
        */
        
        //tableModel.modifyRow(selectedRow,m);

        SalesDetail newData = new SalesDetail(dateSel, nameSel, productIDSel, quantitySel, rateSel);
        tableModel.modifyRow(selectedRow, newData);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBuyDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddBuyDetails().setVisible(true);
            }
        });
    }
    ...
    class AddSalesDetailTableModel extends AbstractTableModel {
        ...
        public boolean modifyRow(int i,SalesDetail m)
        {
            data.remove(i);
            data.add(i, m);
            fireTableDataChanged();
